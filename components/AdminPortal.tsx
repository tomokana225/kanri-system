...
const AdminPortal: React.FC = () => {
  ...
  const [users, setUsers] = useState<User[]>([
    { id: 'student1', name: '田中 アリス', email: 'student@test.com', role: 'student' },
    { id: 'teacher1', name: '鈴木先生', email: 'teacher@test.com', role: 'teacher' },
    { id: 'admin1', name: '管理者ユーザー', email: 'admin@test.com', role: 'admin' },
  ]);

  const handleCreateUser = (newUser: Partial<User>) => {
    console.log('ユーザーを作成中:', newUser);
    // 実際のアプリでは、APIを呼び出してデータベース/Firebaseにユーザーを作成します
    // ここではデモンストレーションのためにローカルの状態に追加するだけです
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between sm:items-center">
        <h1 className="text-3xl font-bold text-gray-800 mb-4 sm:mb-0">管理者ダッシュボード</h1>
        <button
